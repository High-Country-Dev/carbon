<!-- Generated from src/sources/netsuite/gaps.ts by `pnpm --filter @carbon/migration generate:gaps`. Do not edit by hand. -->

# What a NetSuite migration leaves behind

Carbon's one-click NetSuite migration brings across the records a
