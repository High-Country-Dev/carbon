...
[Environment variables](/docs/platform/self-hosting/environment-variables) and the
setup section below.
</Callout>
...
<Cards>
  ...
  <Card title="Revisions" href="/docs/reference/items#revisions">
    Why each revision of a part is its own item record.
  </Card>
  <Card title="Environment variables" href="/docs/platform/self-hosting/environment-variables">
    The Onshape variables a deployment needs.
  </Card>
</Cards>
